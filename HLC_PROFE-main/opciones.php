...
<body>
    <div class="container mt-5">
     ...
     <div class="card my-4">
        ...
        <div class="card my-4">
    <div class="card-header">
        <h3>Editar Datos de Alumnos</h3>
    </div>
    <div class="card-body">
        <form action="editarAlumno.php" method="POST">
            <div class="mb-3">
                <label for="idEditar" class="form-label">ID del alumno a editar:</label>
                <input type="text" class="form-control" id="idEditar" name="id" placeholder="Introduce el ID del alumno" required>
            </div>
